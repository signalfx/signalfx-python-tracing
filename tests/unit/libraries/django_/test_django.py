...
class TestDjangoConfig(DjangoTestSuite):
    ...
    def test_get_middleware_returns_desired_object_and_setting(
        self, version, expected_setting
    ):
    ...
    def test_django_config_determines_instrumented_setting_values_with_global_tracer(
        self,
    ):
        config.set_global_tracer = True
